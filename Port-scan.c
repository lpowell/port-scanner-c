		...
		if((socketConnect(socket[x], address, port[x])) < 0){
			...
			switch(port[x]){
				...
				case 21:
					...
					fprintf(f,"\nPort 21 was found open on %s\n", address);

					fprintf(f,"Port 20 && 21 are used for FTP.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_21.htm.\n");

					break;

				case 22:

					fprintf(f,"\nPort 22 was found open on %s\n", address);

					fprintf(f,"Port 22 is used for SSH.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_22.htm.\n");

					break;

				case 23:

					fprintf(f,"\nPort 23 was found open on %s\n", address);

					fprintf(f,"Port 23 is used for Telnet.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_23.htm.\n");

					break;

				case 25:

					fprintf(f,"\nPort 25 was found open on %s\n", address);

					fprintf(f,"Port 25 is used for SMTP.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_25.htm.\n");

					break;

				case 53:

					fprintf(f,"\nPort 53 was found open on %s\n", address);

					fprintf(f,"Port 53 is used for DNS.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_53.htm.\n");

					break;

				case 139:

					fprintf(f,"\nPort 139 was found open on %s\n", address);

					fprintf(f,"Port 139 is used for NetBIOS.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_139.htm.\n");

					break;

				case 445:

					fprintf(f,"\nPort 445 was found open on %s\n", address);

					fprintf(f,"Port 445 is used for SMB.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_445.htm.\n");

					break;

				case 1433:

					fprintf(f,"\nPort 1433 was found open on %s\n", address);

					fprintf(f,"Ports 1433,1434, and 3306 are used for SQL.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_1433.htm.\n");

					break;

				case 1434:

					fprintf(f,"\nPort 1434 was found open on %s\n", address);

					fprintf(f,"Ports 1433,1434, and 3306 are used for SQL.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_1434.htm.\n");

					break;

				case 3306:

					fprintf(f,"\nPort 3306 was found open on %s\n", address);

					fprintf(f,"Ports 1433,1434, and 3306 are used for SQL.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_3306.htm.\n");

					break;

				case 3389:

					fprintf(f,"\nPort 3389 was found open on %s\n", address);

					fprintf(f,"Port 3389 is used for Remote Desktop.\n");

					fprintf(f,"For more information, please visit: https://www.grc.com/port_3389.htm.\n");
				...
				case 80:
					...
					fprintf(f,"For more information, please visit: https://www.grc.com/port_80.htm.\n");
				...
				case 443:
					...
					fprintf(f,"For more information, please visit: https://www.grc.com/port_443.htm.\n");
